...
export default function GuessTheGroupPage() {
  ...
  useDocumentMeta({
    ...
    description: 'Hear one daily K-pop clip and name the group in 3 tries. A cross-group K-pop guessing game from all 34 groups, new every day at midnight KST.',
