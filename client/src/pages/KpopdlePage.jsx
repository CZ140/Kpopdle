...
export default function KpopdlePage() {
  ...
  useDocumentMeta({
    ...
    description: 'One daily K-pop song drawn from all 34 groups — guess it in 6 tries without knowing the group. A new cross-group K-pop Heardle challenge every day at midnight KST.',
    path: '/kpopdle',
  })
    ...
    <GroupContext.Provider value={{ id: 'kpopdle', archiveDate, setArchiveDate, launchDate: KPOPDLE_LAUNCH, practiceMode: false, difficulty, setDifficulty }}>
      ...
      >
        ...
        <GameAboutSection
          ...
          paragraphs={[
            'K-POPDLE is a free, daily K-pop song-guessing game in the Heardle tradition. Each day at midnight KST, one track is drawn from a pool spanning 34 of the biggest K-pop groups — from 2nd-gen legends like BIGBANG, Girls’ Generation, SHINee, and EXO, through 3rd- and 4th-gen powerhouses like BTS, BLACKPINK, TWICE, SEVENTEEN, Stray Kids, NewJeans, LE SSERAFIM, aespa, and IVE, all the way to 5th-gen rookies like BABYMONSTER, RIIZE, BOYNEXTDOOR, TWS, and ILLIT — and your job is to identify the song in six tries from progressively longer audio clips.',
            'Because the daily song can come from any of the 34 active groups, K-POPDLE is the toughest of the K-popdle modes — it rewards broad K-pop knowledge across 2nd-, 3rd-, 4th- and 5th-generation acts. The catalog spans 2,000+ songs ranging from debut tracks and title cuts to B-sides and recent comebacks, so even longtime listeners regularly meet a tune they only half-remember.',
